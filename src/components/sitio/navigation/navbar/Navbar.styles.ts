export const navbarStyles = {
  ...
  container:
    "mx-auto flex h-20 sm:h-22 max-w-7xl 2xl:max-w-[94vw] 3xl:max-w-[92vw] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8 2xl:px-10 tv:px-12 3xl:px-16",
