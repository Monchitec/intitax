export const heroStyles = {
  ...
  // Titles (Más grande y expansivo en Desktop/Laptop/TV desde 2xl)
  title:
    "text-[38px] sm:text-[52px] lg:text-[62px] xl:text-[72px] 2xl:text-[80px] tv:text-[86px] 3xl:text-[96px] font-black tracking-tight text-foreground leading-[1.05] 2xl:leading-[1.02]",
  titleStart: "block",
  titleHighlight: "text-primary block",
  subtitle:
    "mt-3 sm:mt-4 lg:mt-5 2xl:mt-6 max-w-xl lg:max-w-2xl 2xl:max-w-3xl 3xl:max-w-4xl text-sm sm:text-base lg:text-lg xl:text-xl 2xl:text-2xl text-muted-foreground leading-relaxed",

  // CTA Action Buttons
  ctaGroup:
    "mt-4 sm:mt-6 2xl:mt-8 3xl:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3.5 2xl:gap-4.5 tv:gap-5",
  ctaBtnPrimary:
    "px-7 py-3 2xl:px-9 2xl:py-4 text-base 2xl:text-lg font-bold shadow-md shadow-primary/25",
  ctaBtnSecondary:
    "px-6 py-3 2xl:px-8 2xl:py-4 text-base 2xl:text-lg font-semibold",
};
